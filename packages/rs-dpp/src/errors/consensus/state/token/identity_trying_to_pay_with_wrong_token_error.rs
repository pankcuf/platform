...
pub struct IdentityTryingToPayWithWrongTokenError {
    pub expected_contract_id: Option<Identifier>,
    pub expected_token_contract_position: TokenContractPosition,
    pub expected_token_id: Identifier,

    pub actual_contract_id: Option<Identifier>,
    pub actual_token_contract_position: TokenContractPosition,
    pub actual_token_id: Identifier,
}
